<?php
/**
 * Skyfronts_GmailSmtpApp Magento component
 *
 * @category    Skyfronts
 * @package     Skyfronts_GmailSmtpApp
 * @author      Skyfronts Team <info@Skyfronts.com>
 * @copyright   Skyfronts (http://www.Skyfronts.com)
 * @license     http://opensource.org/licenses/osl-3.0.php  Open Software License (OSL 3.0)
 */

namespace Skyfronts\GmailSmtpApp\Helper;
...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    /**
      * Get system config port smtp
      *  
    */

    public function getConfigPortEmail($store_id = null){
