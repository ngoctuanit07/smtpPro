<?php
namespace Skyfronts\GmailSmtpApp\Controller\Adminhtml\Test;
...
class Index extends Action
{
    ...
    /**
     * @var \Skyfronts\GmailSmtpApp\Helper\Data
     */
     ...
     * @param \Skyfronts\GmailSmtpApp\Helper\Data $dataHelper
     */
    public function __construct(
        Context $context,
        PageFactory $resultPageFactory,
        \Skyfronts\GmailSmtpApp\Helper\Data $dataHelper
    ) {
    ...
    public function execute() {
        ...
        $name = 'Skyfronts Gmail Smtp App Test';
        ...
        $mail->addTo($to, $to);
        $mail->setSubject('Hello from Skyfronts');
        $mail->setBodyText('Thank you for choosing Skyfronts extension.');
    ...
    {
        return $this->_authorization->isAllowed('Skyfronts_GmailSmtpApp');
    }
